            ...
            <div className="text-justify text-xl">
              <h2>
                <p className=" pl-5 pt-5 pb-5">
                  We are a Creative Tech Enthusiast working since 2015.
                </p>
              </h2>
              <p className="pl-5 pt-5 pb-5 mb-3 text-black-600 dark:text-black-400 first-line:uppercase first-line:tracking-widest first-letter:text-7xl first-letter:font-bold first-letter:text-black dark:first-letter:text-black first-letter:mr-3 first-letter:float-left">
                Welcome to Meerako Properties, where we believe that every
                client is unique and deserves a personalized experience when
                buying, selling, or renting a property.
              </p>
              <div className="indent-5">
                Our team of real estate experts is passionate about providing
                exceptional services to our clients and making sure that their
                needs are met. We are a leading real estate agency that has been
                in the business for over a decade, providing top-notch services
                to our clients in the United States.{" "}
              </div>
              <div className="indent-5 mt-5">
                We are proud of our reputation for excellence and are committed
                to maintaining it. Our team is dedicated to staying up-to-date
                with the latest industry trends and technology to ensure that we
                continue to offer the best service possible.
              </div>
            </div>
              ...
              <div className="mx-auto h-42 p-5 my-5">
                <div className="bg-white h-auto shadow-2xl mb-6 mx-1 md:mx-10 py-1 md:py-5">
                  ...
                  <div className="px-4 py-2 mt-2">
                    ...
                    />
                    <h2 className="font-bold text-center text-lg md:text-4xl text-gray-800 tracking-normal">
                      {value.title}
                      <div className="px-10 md:px-5">
                        <p className="font-normal text-gray-700 pt-5 mr-1 text-lg md:px-5 md:text-xl text-justify">
                          {value.desc}
                          <Image
